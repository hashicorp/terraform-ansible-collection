...
"""Unit tests for the azure_oidc_configuration_info module."""

from unittest.mock import Mock, patch

from ansible_collections.hashicorp.terraform.plugins.modules.azure_oidc_configuration_info import main

MODULE_PATH = "ansible_collections.hashicorp.terraform.plugins.modules.azure_oidc_configuration_info"
...
def test_found(mock_get, mock_module_class):
    ...
    mock_get.return_value = {"id": "oidc-1", "client_id": "c"}

    main()

    mock_get.assert_called_once_with(mock_adapter, "azure", "oidc-1")
