...
class TestConfigurationVersionInfo:
    ...
    def test_success_with_configuration_version_id(self, mock_ansible_module, mock_terraform_client, mock_get_config, enhanced_dummy_module):
        ...
        mock_get_config.assert_called_once_with(adapter, configuration_version_id)
    ...
    @patch("ansible_collections.hashicorp.terraform.plugins.modules.configuration_version_info.TerraformClient")
    @patch("ansible_collections.hashicorp.terraform.plugins.modules.configuration_version_info.AnsibleTerraformModule")
    def test_configuration_version_not_found(self, mock_ansible_module, mock_terraform_client, mock_get_config, enhanced_dummy_module):
    ...
    @patch("ansible_collections.hashicorp.terraform.plugins.modules.configuration_version_info.TerraformClient")
    @patch("ansible_collections.hashicorp.terraform.plugins.modules.configuration_version_info.AnsibleTerraformModule")
    def test_get_config_exception(self, mock_ansible_module, mock_terraform_client, mock_get_config, enhanced_dummy_module):
        configuration_version_id = "cv-1234"
    ...
    @patch("ansible_collections.hashicorp.terraform.plugins.modules.configuration_version_info.TerraformClient")
    @patch("ansible_collections.hashicorp.terraform.plugins.modules.configuration_version_info.AnsibleTerraformModule")
    def test_client_creation_error_uses_fail_json(self, mock_ansible_module, mock_terraform_client, mock_get_config, enhanced_dummy_module):
        mock_module = enhanced_dummy_module
        mock_module.params = {
            "configuration_version_id": "cv-1234",
            "tfe_token": "token",
        ...
        mock_terraform_client.side_effect = RuntimeError("client-init-failed")
