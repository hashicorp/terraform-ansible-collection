...
DOCUMENTATION = r"""
---
module: vault_oidc_configuration_info
version_added: "2.2.0"
short_description: Retrieve information about an HCP Terraform Vault OIDC configuration.
author: "Sivaselvan I (@isivaselvan)"
description:
  - Retrieves a Vault OIDC configuration by its unique ID.
...
EXAMPLES = r"""
- name: Retrieve a Vault OIDC configuration by ID
  hashicorp.terraform.vault_oidc_configuration_info:
    oidc_configuration_id: "oidc-vault-1"
...
changed:
  ...
  sample: false
oidc_configuration:
  description: A dictionary containing the Vault OIDC configuration information.
  returned: always
  type: dict
  contains:
    id:
