...
DOCUMENTATION = r"""
---
module: aws_oidc_configuration_info
version_added: "2.2.0"
short_description: Retrieve information about an HCP Terraform AWS OIDC configuration.
author: "Sivaselvan I (@isivaselvan)"
description:
  - Retrieves an AWS OIDC configuration by its unique ID.
...
EXAMPLES = r"""
- name: Retrieve an AWS OIDC configuration by ID
  hashicorp.terraform.aws_oidc_configuration_info:
    oidc_configuration_id: "oidc-aws-1"
  register: aws_oidc_config
"""
...
changed:
  ...
  sample: false
oidc_configuration:
  description: A dictionary containing the AWS OIDC configuration information.
  returned: always
  type: dict
  contains:
    id:
