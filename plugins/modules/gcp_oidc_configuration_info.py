...
DOCUMENTATION = r"""
---
module: gcp_oidc_configuration_info
version_added: "2.2.0"
short_description: Retrieve information about an HCP Terraform GCP OIDC configuration.
author: "Sivaselvan I (@isivaselvan)"
description:
  - Retrieves a GCP OIDC configuration by its unique ID.
...
EXAMPLES = r"""
- name: Retrieve a GCP OIDC configuration by ID
  hashicorp.terraform.gcp_oidc_configuration_info:
    oidc_configuration_id: "oidc-gcp-1"
  register: gcp_oidc_config
"""
...
changed:
  ...
  sample: false
oidc_configuration:
  description: A dictionary containing the GCP OIDC configuration information.
  returned: always
  type: dict
  contains:
    id:
